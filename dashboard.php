...
$activeForms = $pdo->query("SELECT * FROM forms WHERE is_active = 1 ORDER BY form_name")->fetchAll(PDO::FETCH_ASSOC);
                ...
                <div class="card-body">
                    <div class="quick-grid">
                        ...
                        <div class="quick-card <?= ($exists && $canAccess) ? '' : 'disabled' ?>">
                            ...
                            <?php if ($exists && $canAccess): ?>
                                <a href="<?= $file ?>" class="btn btn-primary">Buka Form</a>
                            <?php else: ?>
                                <span class="btn btn-disabled"><?= $canAccess ? 'Tidak Tersedia' : '⛔ Tidak Ada Akses' ?></span>
                            <?php endif; ?>
                        </div>
                        <?php endforeach; ?>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="submission-table">
                        <thead><tr><th>#</th><th>Form</th><th>Tanggal</th><th>Status</th><th>Aksi</th></tr></thead>
                        <tbody>
